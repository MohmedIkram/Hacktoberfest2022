...
import { formatTimeUpdated } from '../../../helpers/utils';

const Repository = ({ repo }) => {
    const updatedAt = formatTimeUpdated(repo.updatedAt);
    ...
    return (
        <div className='repository'>
            <div className="repository-details">
                ...
                <h3 className="repository-forked">
                    {
                        repo.parent ? (
                ...
                <h3 className="repository-description">
                    {repo.description ? repo.description : ''}
                </h3>

                <div className="stats repository-stats">
                    {repo.languages.nodes.length ? (
                        <div>
                            <i className="fas fa-circle" style={{color: `${repo.languages.nodes[0].color}`}}></i>
                    ...
                    <h3 className="repository-update">
                        Updated {updatedAt}
                    </h3>
                </div>
